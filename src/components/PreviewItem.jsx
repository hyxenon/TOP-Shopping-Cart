...
const PreviewItem = () => {
  const {
    item: { name, price, img },
  } = useContext(PreviewItemContext);
  const { count, addToCart, addCount, minusCount, setCount } =
      ...
      <div className="pl-44 pr-52 mt-10 flex gap-32 items-center justify-center">
        ...
        <div className="pt-24   w-[40%]">
          ...
          <p className="mt-11 text-gray-600">
            ...
            mollitia ea cupiditate officiis. Esse dicta incidunt optio eaque
            doloribus velit blanditiis alias minus, sequi inventore, quos
            aperiam, aut labore libero.
          </p>
          ...
          <div className="flex items-center gap-5 mt-11">
            <div className="flex items-center gap-8 bg-blue-100 rounded-lg py-2 px-4">
              <i
                onClick={minusCount}
                className="fa-solid fa-minus cursor-pointer text-primary hover:text-orange-600 active:scale-110 transition-all"
              ></i>
              <p>{count}</p>
              <i
                onClick={addCount}
                className="fa-solid fa-plus cursor-pointer text-primary hover:text-orange-600 active:scale-110 transition-all"
              ></i>
            </div>
            <div
              onClick={() => {
              ...
              className="flex py-4 w-1/2 bg-primary items-center justify-center rounded-xl shadow-md gap-4 cursor-pointer hover:bg-orange-400 active:scale-110 transition-all"
            >
